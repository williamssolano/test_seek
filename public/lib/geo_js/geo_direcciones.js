...
function uploadAddressFile(){
    ...
    var ubigeo = $("#geo_trama_distrito").val();
     ...
     * Validacion:
     * 
     * 1. No selecciono archivo
     * 2. Tamaño de archivo <= 0
    ...
    if ( ubigeo.substring(4, 6) === '00' ) {
        alert("Seleccione un distrito.");
        $("#geo_trama_distrito").focus();
        return false;
    }
...
function searchAddressTimer() {console.log(addressArray);
